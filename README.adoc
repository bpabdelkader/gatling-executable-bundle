...
= Gatling Tests as an Executable Bundle image:https://travis-ci.org/bpabdelkader/gatling-executable-bundle.svg?branch=master["Build Status", link="https://travis-ci.org/bpabdelkader/gatling-executable-bundle"] image:https://sonarcloud.io/api/project_badges/measure?project=bpabdelkader_gatling-executable-bundle&metric=alert_status["Quality Gate Status", link="https://sonarcloud.io/dashboard?id=bpabdelkader_gatling-executable-bundle"] image:https://jitpack.io/v/bpabdelkader/gatling-executable-bundle.svg["JitPack", link="https://jitpack.io/#bpabdelkader/gatling-executable-bundle"]
